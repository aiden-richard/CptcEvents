...
{
    /// <inheritdoc />
    public partial class SeedGroupsAndEventsCorrectly : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "admin-role-id", "a93c7ebe-b801-4843-9a26-38943f4a45d7", "Admin", "ADMIN" },
                    { "staff-role-id", "fb5c9cd4-010f-4285-84ca-99ddd7e541c2", "Staff", "STAFF" },
                    { "student-role-id", "c0dc756a-f9f7-4eaa-9525-658db4bae84f", "Student", "STUDENT" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "admin-user-id", 0, "50af8439-ef29-4b16-895b-38e55a2009b8", "admin@cptc.edu", true, "Admin", "User", false, null, "ADMIN@CPTC.EDU", "ADMIN@CPTC.EDU", "AQAAAAIAAYagAAAAEFyFKOLx/AJhkWoFwpz60MkKvaleHmtSdqjyppyonMZ3cF4RnsiQiR8tHLnmM8dmcg==", null, false, null, "8131ece5-5ab8-4238-a17d-51c3afc15fa8", false, "admin@cptc.edu" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "#007bff", new DateTime(2025, 12, 10, 0, 0, 0, 0, DateTimeKind.Utc), "Default group for CPTC events and announcements", "Cptc Dates", "admin-user-id", 0 });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "GroupId", "InviteId", "JoinedAt", "Role", "UserId" },
                values: new object[] { 1, 1, null, new DateTime(2025, 12, 10, 0, 0, 0, 0, DateTimeKind.Utc), 2, "admin-user-id" });
        }
