...
/// <summary>
/// Extension methods for <see cref="AuthorizationResult"/> to convert authorization failures into appropriate HTTP responses.
/// </summary>
public static class AuthorizationResultExtensions
{
    ...
    public static IActionResult ToActionResult(this AuthorizationResult result, Controller controller)
    {
