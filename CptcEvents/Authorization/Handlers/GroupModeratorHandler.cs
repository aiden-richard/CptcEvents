...
/// <summary>
/// Authorization handler that enforces <see cref="GroupModeratorRequirement"/>.
/// Checks if a user is a moderator (or owner) of a specific group extracted from the route data.
/// </summary>
